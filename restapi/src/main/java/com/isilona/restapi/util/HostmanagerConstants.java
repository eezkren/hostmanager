...
public final class HostmanagerConstants {
    ...
    public static final class Privileges {
        ...
        // Host Record Privilege
        public static final String ROLE_HOST_RECORD_READ = "ROLE_HOST_RECORD_READ";
        public static final String ROLE_HOST_RECORD_WRITE = "ROLE_HOST_RECORD_WRITE";
