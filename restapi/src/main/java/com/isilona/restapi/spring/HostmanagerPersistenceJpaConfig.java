...
@ComponentScan({"com.isilona.restapi.persistence"})
@PropertySource({"classpath:persistence-${persistenceTarget:h2}.properties"})
@EnableJpaRepositories(basePackages = "com.isilona.restapi.persistence.dao")
public class HostmanagerPersistenceJpaConfig {

    @Autowired
    private Environment env;

    public HostmanagerPersistenceJpaConfig() {
        super();
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[]{"com.isilona.restapi"});
